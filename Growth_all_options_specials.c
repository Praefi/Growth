...
void opague_builder (Spielfeld Field, Special_Fields Opague_o, unsigned int m, unsigned int n, unsigned int geben, unsigned int AOP, Special_Fields Allocation_o, unsigned int number_of_players, unsigned int gamemode_played) {	//checklist
	unsigned int extra;
	...
	extra = 13;	//alle zusätzlichen Werte neben den AOP-Spielerwerten, go on
