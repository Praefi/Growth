...
Growth_all.exe: Growth_all.o Growth_all_Def.o Growth_all_Vektor.o Growth_all_show.o Growth_all_visual.o Growth_all_Initialisierung.o Growth_all_set.o Growth_all_get.o Growth_all_Development.o Growth_all_gamemode_specials.o Growth_all_options_specials.o Growth_all_actions.o Growth_all_KI.o
	gcc $(CFLAGES) -o Growth_all.exe Growth_all.o Growth_all_Def.o Growth_all_Vektor.o Growth_all_show.o Growth_all_visual.o Growth_all_Initialisierung.o Growth_all_set.o Growth_all_get.o Growth_all_Development.o Growth_all_gamemode_specials.o Growth_all_options_specials.o Growth_all_actions.o Growth_all_KI.o -lm
